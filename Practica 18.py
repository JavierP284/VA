# Javier Alejandro Perez Nuño
# 22310284
#Practica 18: Clasificación de imágenes con CIFAR-10 usando PyTorch
...
# Definición de las clases de CIFAR-10
...
# Función de prueba y reporte de precisión por clase
...
def main():
    ...
    # Transformaciones de datos para aumentar robustez
    ...
    # Inicialización de la red, función de pérdida, optimizador y scheduler
    ...
    # Seleccionar 4 imágenes aleatorias del conjunto de prueba para mostrar resultados
    all_images = []
    all_labels = []
    ...
    # Selección aleatoria de 4 índices
    ...
    # Mostrar las imágenes seleccionadas y sus etiquetas reales y predichas
